...
async function main() {
    ...
    const db = await mongoose.connect('mongodb+srv://shatabarman3:5J46BAQg6RLClnll@cluster.htctynm.mongodb.net/Hospital_API?retryWrites=true&w=majority');
...
main()
    ...
    .catch(err => console.log(err)); // If an error occurs during connection
